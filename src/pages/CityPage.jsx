...
export default function CityPage({ setMode, setShowAuthModal }) {
  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <section className="py-16 px-4 bg-white" aria-label="Şehre Özel Kullanıcı Profilleri">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-black text-slate-900 text-center mb-3">{cityName} Profil Önerileri</h2>
          <p className="text-center text-slate-500 font-medium mb-10">{cityName}'dan her gün onlarca yeni üye katılıyor. Onlarla tanışmak için profillere göz at!</p>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
            {[
              ...
              >
                ...
                <p className="text-xs text-slate-500 mt-0.5">{profile.age} · {cityName}</p>
