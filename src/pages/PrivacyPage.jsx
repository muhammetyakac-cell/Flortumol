    ...
    <div className="flex-1 bg-white">
      ...
      <section className="py-12 px-4">
        <div className="max-w-3xl mx-auto prose prose-slate">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">4. Bilgilerinizin Paylaşımı</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">5. Hesap Silme</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
