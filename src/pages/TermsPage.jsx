...
export default function TermsPage() {
  return (
    <div className="flex-1 bg-surface-50">
      ...
      <section className="bg-surface-100 border-b border-surface-200 py-16 px-4 text-center">
        <h1 className="text-4xl font-black text-surface-900 mb-4">Kullanım Koşulları</h1>
        <p className="text-stone-500 font-medium">Lütfen platformumuzu kullanmadan önce dikkatlice okuyunuz.</p>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="max-w-3xl mx-auto prose prose-slate">
          ...
          <h2 className="text-2xl font-bold text-surface-900 mt-8 mb-4">1. Yaş Sınırı</h2>
          ...
          <h2 className="text-2xl font-bold text-surface-900 mt-8 mb-4">2. Topluluk Kuralları ve Saygı</h2>
          <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-surface-900 mt-8 mb-4">3. Gerçek Profil Kullanımı</h2>
          <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-surface-900 mt-8 mb-4">4. İçerik Sorumluluğu</h2>
          <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-surface-900 mt-8 mb-4">5. Koşullarda Değişiklik</h2>
          <p className="text-stone-600 leading-relaxed mb-4">
