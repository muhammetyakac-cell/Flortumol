  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <section className="relative text-center px-4 overflow-hidden min-h-[92vh] flex flex-col justify-center items-center">
        {/* Three.js Interactive Shader + Particle Background */}
        <HeroCanvas />
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            {[
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-slate-800/80 flex items-center justify-center text-2xl mb-4 border border-slate-700/50">
                  {f.icon}
                </div>
