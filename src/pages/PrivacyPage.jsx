  ...
  return (
    <div className="flex-1 bg-surface-50">
      ...
      <section className="bg-surface-100 border-b border-surface-200 py-16 px-4 text-center">
        <h1 className="text-4xl font-black text-surface-900 mb-4">Gizlilik Politikası</h1>
        <p className="text-stone-500 font-medium">Son Güncelleme: 1 Ocak 2026</p>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="max-w-3xl mx-auto prose prose-slate">
          ...
          <h2 className="text-2xl font-bold text-surface-900 mt-8 mb-4">1. Toplanan Veriler</h2>
          ...
          <h2 className="text-2xl font-bold text-surface-900 mt-8 mb-4">2. Veri Güvenliği ve Şifreleme</h2>
          <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-surface-900 mt-8 mb-4">3. Çerezler (Cookies)</h2>
          <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-surface-900 mt-8 mb-4">4. Bilgilerinizin Paylaşımı</h2>
          <p className="text-stone-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-surface-900 mt-8 mb-4">5. Hesap Silme</h2>
          <p className="text-stone-600 leading-relaxed mb-4">
